...
var calculatedPaymentValue=(parseFloat(totalNonPromoBalance)+parseFloat(promoMinPmtAmt)).toFixed(2);
document.getElementById("payInfoCalcPaymentValue").innerText=calculatedPaymentValue;
//Safe Payment Amount = Round Calc Payment Amount to nearest 10's place
document.getElementById("payInfoSafePaymentValue").innerText=Math.ceil((calculatedPaymentValue+1)/10)*10+".00";
